...
const initialState ={email:'',password:'',confirmPassword:'',role:'citizen',phoneNumber:''};
      ...
      <div className="form-container">
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div className="internal-form-container">
            ...
            <div>
              <input name="name" onChange={handleChange} type="text" id="name" required />
            </div>
          </div>
          <div className="internal-form-container">
            <div>
            ...
            <div>
              <input name="email" onChange={handleChange} type="email" id="email" required />
            </div>
          </div>
          <div className="internal-form-container">
            <div>
          ...
          <div className="internal-form-container">
            ...
            <div>
              <input name="password" onChange={handleChange} type="password" id="password" required />
            </div>
          </div>
          <div className="internal-form-container">
            <div>
